...
const About = () => {
    return (
        <div id='artverse' className='py-10 px-8'>
            ...
            <div>
                <h3 className='text-2xl'>A Community of Art Lovers</h3>
                <p className=''>Art is incredibly powerful; it can make us dance, cry, and everything in between! We wish to cultivate a community of people who believe in the value of art, rather than continually ask ‘‘what is the utility?
                </p>
