    ...
    <div>
      ...
      >
        ...
        <h4>Simplifying the Artist-Collector Experience</h4>
          <p>​We are streamlining the collecting experience by removing the noise so artists can concentrate on creating and collectors never miss a drop from their favorite artist!
</p>
        </SwiperSlide>
        <SwiperSlide>
        <h4>Amplifying Artist Voices</h4>
