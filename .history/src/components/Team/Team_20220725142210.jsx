                ...
                <div>
                    <div className='text-center'>
                        ...
                        <div className='flex justify-center'>
                            <a href='https://twitter.com/0xWanderbitch' className='mr-2' target='_blank' rel="noreferrer"><AiFillTwitterSquare className='social-icon'/></a>
                            <a href='https://www.instagram.com/thetravelingelf/' target='_blank' rel="noreferrer"><AiFillInstagram className='social-icon'/></a>
                        </div>
                    </div>
                    <div></div>
                    <div></div>
