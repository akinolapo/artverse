            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                <div>
                    <div className='text-center'>
                        <img className='rounded-full' src={process.env.PUBLIC_URL+`assets/founder.webp`} alt='Founder' className=''></img>
                        <h5>Rachel Wood</h5>
                        <h6>Founder</h6>
                        <div className='flex justify-center'>
                            <a href='https://twitter.com/0xWanderbitch' className='mr-2' target='_blank' rel="noreferrer"><AiOutlineTwitter/></a>
                            <a href='https://www.instagram.com/thetravelingelf/' target='_blank' rel="noreferrer"><AiOutlineInstagram/></a>
                        </div>
                    </div>
                    <div></div>
                    <div></div>
